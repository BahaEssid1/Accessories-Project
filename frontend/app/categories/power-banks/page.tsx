...
//   useEffect(() => {
//     // Fetch product list from catalog service (replace URL with actual service endpoint)
//     const fetchProducts = async () => {
//       try {
//         const response = await fetch("/api/catalog/power-bank");
//         const data = await response.json();
//         setProducts(data); // Set the products fetched from the API
//       } catch (error) {
