...
//     try {
//       // Simulate an API call to authenticate (you can replace this with actual API logic)
//       const data = await loginUser({ email, password });
//       console.log(data);
      
//       // If login is successful, use context to update the state
//       if (data.token) {
//         login(data.token); // Save token globally using context
        
//         // Mock user data - replace with actual data from API response
//         const userData = { email, name: 'User Name', phone: '1234567890', bio: 'This is a bio' };
